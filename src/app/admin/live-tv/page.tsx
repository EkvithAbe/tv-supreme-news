...
type StreamType = "HLS" | "YouTube" | "Embed";

export default function LiveTVPage() {
  const [isLive, setIsLive] = useState(false);
  const [streamType, setStreamType] = useState<StreamType>("HLS");

  const [channelName, setChannelName] = useState("TV SUPREME");
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm text-slate-500">
            Manage the TV SUPREME live stream, player settings and
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <StatusCard
          ...
          note={isLive ? "Broadcast is active" : "No active broadcast"}
          icon={<Radio size={20} />}
          active={isLive}
        />
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Configure the live broadcast source used by the
                  public website.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-5 p-5">
            ...
            <div>
              ...
              <div className="grid gap-2 sm:grid-cols-3">
                {(["HLS", "YouTube", "Embed"] as StreamType[]).map(
                  (type) => {
                    const active = streamType === type;
            ...
            <div>
              ...
              <p className="mt-2 text-xs leading-5 text-slate-400">
                Optional backup stream used when the primary stream
                is unavailable.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
              <div className="mb-4">
                ...
                <p className="mt-1 text-xs text-slate-400">
                  Control how the live player behaves on the public
                  website.
                </p>
              </div>
            ...
            <div className="flex flex-col-reverse gap-3 border-t border-slate-100 pt-5 sm:flex-row sm:justify-end">
              <button
                ...
                onClick={() => {
                  setStreamUrl("");
                  setFallbackUrl("");
                  setPlayerTitle("TV SUPREME Live");
                  setChannelName("TV SUPREME");
                  setStreamType("HLS");
                  setAutoPlay(true);
                  setShowChat(false);
                }}
              ...
              <button
                type="button"
                onClick={handleSave}
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-pink-600 to-purple-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:opacity-90"
              >
                {saved ? (
                  <>
                    <Check size={16} />
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Preview how your live broadcast will appear.
                  </p>
                </div>
              </div>
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
                  ...
                  {!isLive && (
                    <button
                      type="button"
                      onClick={toggleLive}
                      className="mt-5 inline-flex items-center gap-2 rounded-xl bg-white px-4 py-2.5 text-xs font-bold text-slate-900 transition hover:bg-slate-100"
                    >
                      <Play
                        size={14}
                        fill="currentColor"
      ...
      <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div className="border-b border-slate-200 px-5 py-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Quick overview of the current live TV settings.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-4 p-5 sm:grid-cols-2 lg:grid-cols-4">
          <ConfigItem
            label="Channel"
            value={channelName || "Not configured"}
          />

          <ConfigItem
            label="Player Title"
            value={playerTitle || "Not configured"}
          />
        ...
        <div className="border-t border-slate-100 bg-slate-50/70 px-5 py-4">
          <p className="text-xs leading-5 text-slate-400">
            Live TV settings are currently stored in local UI state.
            They will be connected to PostgreSQL and the CMS API
            later.
          </p>
        </div>
      </section>
